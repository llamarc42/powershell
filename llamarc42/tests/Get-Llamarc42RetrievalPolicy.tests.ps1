...
Describe 'Get-Llamarc42RetrievalPolicy' {
    Context 'When ConvertFrom-Yaml is not available' {
        It 'throws an error referencing powershell-yaml' {
            ...
            Mock Get-Command -ModuleName llamarc42 -ParameterFilter { $Name -eq 'ConvertFrom-Yaml' } {
                $null
            }
            { Get-Llamarc42RetrievalPolicy -ProjectFolder $projectDir } |
    ...
    Context 'When the policy file does not exist' {
        ...
        It 'throws an error about the missing file' {
            ...
            { Get-Llamarc42RetrievalPolicy -ProjectFolder $projectDir -PolicyPath $missingPolicyPath } |
    ...
    Context 'When ConvertFrom-Yaml is available and returns a valid policy' {
        BeforeAll {
            ...
            Mock ConvertFrom-Yaml -ModuleName llamarc42 {
                @{
                    version   = 1
        ...
        It 'returns an object with PSTypeName Llamarc42.RetrievalPolicy' {
            $result = Get-Llamarc42RetrievalPolicy -ProjectFolder $projectDir
    ...
    Context 'When the parsed policy is missing required sections' {
        ...
        It 'throws when version is missing' {
            ...
            { Get-Llamarc42RetrievalPolicy -ProjectFolder $projectDir } | Should -Throw '*version*'
        }
        ...
        It 'throws when global section is missing' {
            ...
            { Get-Llamarc42RetrievalPolicy -ProjectFolder $projectDir } | Should -Throw '*global*'
        }
        ...
        It 'throws when project section is missing' {
            ...
            { Get-Llamarc42RetrievalPolicy -ProjectFolder $projectDir } | Should -Throw '*project*'
        }
        ...
        It 'throws when retrieval section is missing' {
            ...
            { Get-Llamarc42RetrievalPolicy -ProjectFolder $projectDir } | Should -Throw '*retrieval*'
        }
    }
}
