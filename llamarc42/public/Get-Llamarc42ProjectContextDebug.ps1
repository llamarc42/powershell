...
.EXAMPLE
Get-Llamarc42ProjectContextDebug -Intent review -ProjectFolder .

.EXAMPLE
Get-Llamarc42ProjectContextDebug -Intent coding -PolicyPath './tooling/config/retrieval.yaml'

.OUTPUTS
Llamarc42.ContextDebug
#>
function Get-Llamarc42ProjectContextDebug {
    [CmdletBinding()]
    param(
        [Parameter()]
