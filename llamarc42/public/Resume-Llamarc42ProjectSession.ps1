...
.EXAMPLE
Resume-Llamarc42ProjectSession -Name 'review'

.OUTPUTS
Llamarc42.ProjectSession
#>
function Resume-Llamarc42ProjectSession {
    [CmdletBinding()]
    param(
        [Parameter()]
    ...
    $sessions = Get-Llamarc42ProjectSessionList -ProjectFolder $ProjectFolder
    ...
    if ([string]::IsNullOrWhiteSpace($Name)) {
        ...
        return Get-Llamarc42ProjectSession -Path $match.SessionFolder
    }
    ...
    return Get-Llamarc42ProjectSession -Path $matches[0].SessionFolder
}
