...
.EXAMPLE
Get-Llamarc42ProjectSessionConversationWindow -Session $session

.EXAMPLE
Get-Llamarc42ProjectSessionConversationWindow -Path $sessionPath -MaxMessages 40 -SummarizeAfter 20

.OUTPUTS
Llamarc42.ConversationWindow
#>
function Get-Llamarc42ProjectSessionConversationWindow {
    ...
    $messages = @(Get-Llamarc42ProjectSessionMessage -Session $resolvedSession)
