...
.EXAMPLE
Update-OllamaProjectSessionSummary -Session $session

.EXAMPLE
Update-OllamaProjectSessionSummary -Path $sessionPath -MaxMessages 40 -SummarizeAfter 20

.OUTPUTS
Ollama.ProjectSession
#>
function Update-OllamaProjectSessionSummary {
    ...
    $window = Get-OllamaProjectSessionConversationWindow `
